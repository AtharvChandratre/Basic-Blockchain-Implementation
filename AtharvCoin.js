...
class Blockchain{
    ...
    createGenesisBlock() {
        return new Block(Date.parse("03-08-1999"), [], "0");
    }
...
console.log('\n Starting the miner...');
AtharvCoin.minePendingTransactions('miners-address');

console.log('\nBalance of miner is', AtharvCoin.getBalanceOfAddress('miners-address'));
